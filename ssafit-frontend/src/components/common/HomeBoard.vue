        ...
        <div class="row">
            <div class="col-6">
                <div id="videoCards" class="carousel slide" data-bs-ride="carousel" style="width:600px; height:300px;">
                    ...
                    <div id="image-container" class="carousel-inner" v-for="(video,index) in videoList.slice(0,5)" :key="video.videoId">
                        <div class="carousel-item" :class="{'carousel-item active' : index === 0}">
                            <iframe
                                    width="600"
                                    height="350"
