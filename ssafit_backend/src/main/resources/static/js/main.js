...
const recentVideosList = document.querySelector(".recent-videos");
...
videoList.forEach((video) => {
      ...
      <div class="col">
        <div class="card card2">
          ...
          <div class="card-body card-body2">
            <h5 class="card-title"><a href="review.html" style="text-decoration:none; color:#000; font-weight:500;">${video.title}</a></h5>
    ...
    recentVideosList.insertAdjacentHTML("beforeend", videoHtml);
});
